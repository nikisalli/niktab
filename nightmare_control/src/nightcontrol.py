...
def hc12_writer():
    while(1):
        ...
        _ly = round(fmap(buf_y1,-1,1,0,255))
        _rx = round(fmap(buf_x2,-1,1,0,255))
        _ry = round(fmap(buf_y2,-1,1,0,255))
        hc.write(_lx)
        hc.write(_ly)
        hc.write(_rx)
        hc.write(_ry)
...
class MyViz( QtWidgets.QWidget ):
    def __init__(self):
        ...
        # right joystick
        self.Rjoystick = Joystick()
        self.Rjoystick.setMinimumSize( 350, 350 )
        
        # left joystick
        self.Ljoystick = Joystick()
        self.Ljoystick.setMinimumSize( 350, 350 )
        ...
        vlayoutL2.addWidget( self.Ljoystick )
        ...
        vlayoutR.addWidget( self.Rjoystick)
    ...
    def draw_joystick( self, x1, x2, y1, y2):
        self.Rjoystick.setPos((y1*150), -(x1*150))
        self.Ljoystick.setPos((y2*150), -(x2*150))
